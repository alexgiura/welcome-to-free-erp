...
const HeroIllustration = () => {
  ...
  return (
    <div className="relative w-full h-[400px] md:h-[500px]">
      {/* Central glow - subtle gray */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-foreground/5 rounded-full blur-3xl" />
      
      {/* Connection lines SVG */}
      <svg className="absolute inset-0 w-full h-full" viewBox="0 0 400 400">
        <defs>
          <linearGradient id="lineGradientBW" x1="0%" y1="0%" x2="100%" y2="100%">
      ...
      {floatingItems.map((item, index) => (
        ...
        >
          ...
          >
            <item.icon className={`${iconSizes[item.size as keyof typeof iconSizes]} text-foreground/70`} />
          </motion.div>
        </motion.div>
      ))}
        ...
        >
          ...
          <div className="flex items-center gap-2 mb-3">
            ...
            <div>
              ...
              <div className="h-1.5 w-10 bg-foreground/10 rounded mt-1" />
            </div>
          </div>
          ...
          <div className="flex gap-2">
            <div className="flex-1 bg-foreground/5 rounded-lg p-2">
              <div className="h-1.5 w-6 bg-foreground/40 rounded mb-1" />
              <div className="h-1 w-10 bg-foreground/20 rounded" />
            </div>
            <div className="flex-1 bg-foreground/5 rounded-lg p-2">
              <div className="h-1.5 w-8 bg-foreground/40 rounded mb-1" />
